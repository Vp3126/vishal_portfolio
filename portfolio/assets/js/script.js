...
class PortfolioApp {
            ...
            this.projects = [
                {
                    ...
                    category: "web",
                    githubUrl: "https://github.com/Vp3126/portfolio",
                    liveUrl: "#",
                    featured: true
                },
                {
                    ...
                    category: "web",
                    githubUrl: "https://github.com/Vp3126/task-manager",
                    liveUrl: "#",
                    featured: true
                },
                {
                    ...
                    category: "ai",
                    githubUrl: "https://github.com/Vp3126/ai-chatbot",
                    liveUrl: "#",
                    featured: true
                }
            ];
    ...
    handleContactForm(e) {
        ...
        // Submit to Formspree
        fetch('https://formspree.io/f/xovpglzd', {
            method: 'POST',
            headers: {
            ...
            .then(async (response) => {
                if (response.ok) {
                    ...
                    e.target.reset();
                    // Redirect to local thank-you page using relative path (no domain/port)
            ...
            .catch((error) => {
                ...
                this.showNotification(`❌ ${error.message} If the issue persists, please email me directly at vp312600@gmail.com`, 'error');
            })
            .finally(() => {
